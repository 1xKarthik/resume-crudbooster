<div class="row justify-content-between">
    ...
    <div class="col-sm-6">
        <div class="socialIcons">
            <a class="socialIcon" id="linkedinIcon" target="_blank" href="https://in.linkedin.com/in/karthikgirraju"></a>
...
<div class="row">
    <ul id="intro" class="sectionBody">
        ...
        <li>Good page layout and design skills, multitasking and handling projects from concept to final
            deliverable.
        </li>
    </ul>
</div>